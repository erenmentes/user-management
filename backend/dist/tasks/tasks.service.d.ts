...
export declare class TasksService {
    ...
    setTaskStatus(id: string, status: TaskStatus, username: string): Promise<import("mongoose").Document<unknown, {}, TaskDocument, {}, {}> & Task & import("mongoose").Document<unknown, any, any, Record<string, any>, {}> & Required<{
        _id: unknown;
    }> & {
        __v: number;
    }>;
    getWeeklyCompletedStats(username: string): Promise<any[]>;
}
